...
- [ ] I have search the [issue list](https://github.com/reidransom/jigyll/issues) for my issue.
- [ ] I have verified the behavior with `jekyll`.
- [ ] I tried hard to create a reproducible test case.

## System information

Liquid version: `jigyll --version`
...
2. A single file that demonstrates the problem. Put this in a directory and run `jigyll -s path/to/directory`, and we'll see the issue.
