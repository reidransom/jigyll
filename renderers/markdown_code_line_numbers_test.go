...
func TestRenderMarkdownCodeLineNumbers(t *testing.T) {
	...
	require.Equal(t, "1", attribute(parsedCode(t, numbered), "data-line-number-width"))
	require.Equal(t, "2", attribute(parsedCode(t, started), "data-line-number-width"))
	require.Equal(t, "6", attribute(parsedCode(t, maximum), "data-line-number-width"))
